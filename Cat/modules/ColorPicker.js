...
;Cat.define("Jquery", function (e) {
    "use strict";
    var i = Cat.Jquery, o = {
            config: {}, index: Cat.ColorPicker ? Cat.ColorPicker.index + 1e4 : 0, set: function (e) {
                var o = this;
                return o.config = i.extend({}, o.config, e), o
            }, on: function (e, i) {
                return Cat.onevent.call(this, "ColorPicker", e, i)
            }
        }, r = function () {
            var e = this, i = e.config;
            return {config: i}
        }, t = "ColorPicker", n = "Cat-show", l = "Cat-ColorPicker", c = ".Cat-ColorPicker-main",
        a = "Cat-icon-down", s = "Cat-icon-close", f = "Cat-ColorPicker-trigger-span",
        d = "Cat-ColorPicker-trigger-i", u = "Cat-ColorPicker-side", p = "Cat-ColorPicker-side-slider",
        g = "Cat-ColorPicker-basis", v = "Cat-ColorPicker-alpha-bgcolor", h = "Cat-ColorPicker-alpha-slider",
        m = "Cat-ColorPicker-basis-cursor", b = "Cat-ColorPicker-main-input", k = function (e) {
    ...
    D.prototype.config = {
        ...
        var e = this, o = e.config,
            r = i(['<div class="Cat-unselect Cat-ColorPicker">', "<span " + ("rgb" == o.format && o.alpha ? 'class="Cat-ColorPicker-trigger-bgcolor"' : "") + ">", '<span class="Cat-ColorPicker-trigger-span" ', 'lay-type="' + ("rgb" == o.format ? o.alpha ? "rgba" : "torgb" : "") + '" ', 'style="' + function () {
                var e = "";
                return o.color ? (e = o.color, (o.color.match(/[0-9]{1,3}/g) || []).length > 3 && (o.alpha && "rgb" == o.format || (e = "#" + C(k(P(o.color))))), "background: " + e) : e
            }() + '">', '<i class="Cat-icon Cat-ColorPicker-trigger-i ' + (o.color ? a : s) + '"></i>', "</span>", "</span>", "</div>"].join("")),
            t = i(o.elem);
        o.size && r.addClass("Cat-ColorPicker-" + o.size), t.addClass("Cat-inline").html(e.elemColorBox = r), e.color = e.elemColorBox.find("." + f)[0].style.background, e.events()
    }, D.prototype.renderPicker = function () {
        var e = this, o = e.config, r = e.elemColorBox[0],
            t = e.elemPicker = i(['<div id="Cat-ColorPicker' + e.index + '" data-index="' + e.index + '" class="Cat-anim Cat-anim-upbit Cat-ColorPicker-main">', '<div class="Cat-ColorPicker-main-wrapper">', '<div class="Cat-ColorPicker-basis">', '<div class="Cat-ColorPicker-basis-white"></div>', '<div class="Cat-ColorPicker-basis-black"></div>', '<div class="Cat-ColorPicker-basis-cursor"></div>', "</div>", '<div class="Cat-ColorPicker-side">', '<div class="Cat-ColorPicker-side-slider"></div>', "</div>", "</div>", '<div class="Cat-ColorPicker-main-alpha ' + (o.alpha ? n : "") + '">', '<div class="Cat-ColorPicker-alpha-bgcolor">', '<div class="Cat-ColorPicker-alpha-slider"></div>', "</div>", "</div>", function () {
                if (o.predefine) {
                    var e = ['<div class="Cat-ColorPicker-main-pre">'];
                    return Cat.each(o.colors, function (i, o) {
                        e.push(['<div class="Cat-ColorPicker-pre' + ((o.match(/[0-9]{1,3}/g) || []).length > 3 ? " Cat-ColorPicker-pre-isalpha" : "") + '">', '<div style="background:' + o + '"></div>', "</div>"].join(""))
                    }), e.push("</div>"), e.join("")
                }
                return ""
            }(), '<div class="Cat-ColorPicker-main-input">', '<div class="Cat-inline">', '<input type="text" class="Cat-input">', "</div>", '<div class="Cat-btn-container">', '<button class="Cat-btn Cat-btn-primary Cat-btn-sm" ColorPicker-events="clear">清空</button>', '<button class="Cat-btn Cat-btn-sm" ColorPicker-events="confirm">确定</button>', "</div", "</div>", "</div>"].join(""));
        ...
        var o = this;
        o.config;
        return i("#Cat-ColorPicker" + (e || o.index)).remove(), o
        ...
        var e = this, o = e.config, r = e.elemColorBox.find("." + f), t = r.attr("lay-type"),
            ...
            j = e.elemColorBox.find("." + d), F = e.elemPicker.find(".Cat-ColorPicker-pre").children("div"),
            L = function (i, n, l, c) {
                e.select(i, n, l);
                var f = x({h: i, s: n, b: l});
            ...
            }, M = i(['<div class="Cat-auxiliar-moving" id="LAY-ColorPicker-moving"></div'].join("")),
            Y = function (e) {
        ...
        l.on("mousedown", function (e) {
            ...
            Cat.stope(e), Y(n), e.preventDefault()
            ...
            i(this).on("click", function () {
                i(this).parent(".Cat-ColorPicker-pre").addClass("selected").siblings().removeClass("selected");
