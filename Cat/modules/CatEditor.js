!function (e, t) {
    if ("object" == typeof exports && "undefined" != typeof module){
        ...
        define(t)
    }else if (window.Cat && Cat.define) {
        Cat.define('Jquery',function (exports) {
            exports('CatEditor',t());
        });
    }else {
        e.wangEditor = t()
    ...
    function j(e, t) {
        ...
        this.id = "CatEditor-" + W++, this.toolbarSelector = e, this.textSelector = t, this.customConfig = {}
    }
    var G = [];
    i.prototype = {
    ...
    var z = {
        ...
        emotions: [{
            ...
            }, {alt: "[污]", src: "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3c/pcmoren_wu_org.png"}]
        }, {
            title: "新浪",
            type: "image",
            content: [{
                ...
                alt: "[神马]"
            }, {src: "https://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/bc/fuyun_thumb.gif", alt: "[浮云]"}]
        }, {
            title: "emoji",
            type: "emoji",
            content: "😀 😃 😄 😁 😆 😅 😂 😊 😇 🙂 🙃 😉 😓 😪 😴 🙄 🤔 😬 🤐".split(/\s/)
    ...
    j.prototype = {
        Propagation:function(e){
            var that =this;
            Cat.use('Jquery',function () {
                let $=Cat.Jquery,TR= e.Event=='onfocus'? true:false;
                $('#'+that.textElemId).on('mousewheel DOMMouseScroll',function (event) {
        ...
        _initConfig: function () {
            var e = {},that=this;
            that.config = Object.assign(e, z, this.customConfig);
            that.config.onfocus=function (){
                var data ={Event:'onfocus',data:''};
                that.Propagation(data)
            };
            that.config.onblur=function (html) {
                var data ={Event:'onblur',data:html};
                that.Propagation(data);
            };
            ...
            var e = this, t = this.toolbarSelector, n = o(t), i = this.textSelector, A = this.config, r = A.zIndex,MinH= typeof A.Minheight =='undefined' ? '300px': A.Minheight,MaxH= typeof A.Maxheight == 'undefined' ? '300px': A.Maxheight,
                a = void 0, s = void 0, l = void 0, d = void 0;
            null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#f1f1f1").css("border", "1px solid #ccc"), s.css("border", "1px solid #ccc").css("border-top", "none").css("height", "auto")) : (a = n, s = o(i), d = s.children()), l = o("<div></div>"), l.attr("contenteditable", "true").css("width", "100%").css("height", "100%").css("min-height", MinH).css("max-height", MaxH), d && d.length ? l.append(d) : l.append(o("<p><br></p>")), s.append(l), a.addClass("w-e-toolbar"), s.addClass("w-e-text-container"), s.css("z-index", r), l.addClass("w-e-text");
