...
;Cat.define("Layer", function (e) {
    "use strict";
    var i = Cat.$, t = Cat.Layer, n = Cat.hint(), a = Cat.device(), o = {
            config: {}, set: function (e) {
                var t = this;
                return t.config = i.extend({}, t.config, e), t
            }, on: function (e, i) {
                return Cat.onevent.call(this, r, e, i)
            }
        }, l = function () {
            var e = this;
            return {
        ...
        }, r = "Upload", u = "Cat-Upload-file", c = "Cat-Upload-form", f = "Cat-Upload-iframe",
        s = "Cat-Upload-choose", p = function (e) {
            var t = this;
    ...
    p.prototype.config = {
        ...
        var e = this, t = e.config,
            ...
            o = t.elem.next();
        (o.hasClass(u) || o.hasClass(c)) && o.remove(), a.ie && a.ie < 10 && t.elem.wrap('<div class="Cat-Upload-wrap"></div>'), e.isFile() ? (e.elemFile = t.elem, t.field = t.elem[0].name) : t.elem.after(n), a.ie && a.ie < 10 && e.initIE()
        ...
        i("#" + f)[0] || i("body").append(n), t.elem.next().hasClass(c) || (e.elemFile.wrap(a), t.elem.next("." + c).append(function () {
            var e = [];
            return Cat.each(t.data, function (i, t) {
        ...
        var i = this;
        window.FileReader && Cat.each(i.chooseFiles, function (i, t) {
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            Cat.each(a, function (e, a) {
                var r = new FormData;
                r.append(l.field, a), Cat.each(l.data, function (e, i) {
            ...
            var i = [];
            return Cat.each(e || o.chooseFiles, function (e, t) {
                i.push(t.name)
            }), i
        }(), g = {
            preview: function (e) {
                ...
                return o.files = o.files || {}, Cat.each(o.chooseFiles, function (e, i) {
                    o.files[e] = i
                }), o.files
        ...
        var e = this, t = e.config, o = function (i) {
            e.chooseFiles = {}, Cat.each(i, function (i, t) {
            ...
            a.next().hasClass(s) && a.next().remove(), e.Upload(null, "choose"), e.isFile() || t.choose || a.after('<span class="Cat-inline ' + s + '">' + o + "</span>")
        };
        t.elem.off("Upload.start").on("Upload.start", function () {
            var a = i(this), o = a.attr("Cat-data");
            if (o) try {
                o = new Function("return " + o)(), e.config = i.extend({}, t, o)
            } catch (l) {
                n.error("Upload element property Cat-data configuration item has a syntax error: " + o)
            }
