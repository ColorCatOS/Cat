Cat.define('Jquery',function (e) {
    var $ = Cat.Jquery,i='CusScrollBar',j=(function(options){Obj._init(options);}),Obj={
        ...
        _initSliderHeight: function() {
            ...
            this.$slider.css('height',sliderHeight/2);
            if (this.ContList_H<this.$cont.height()){
                this.$bar.hide();
            }else {
                this.$bar.show();
            }
        ...
        // 获取文档高度
        getMaxcontentPosition: function() {
            var ContList = this.$cont.children();
            var ContList_H = 0;//文档集合
            for (var i=0;i<ContList.length;i++){
                ContList_H = ContList_H + $(ContList[i]).outerHeight();
            }
            this.ContList_H = ContList_H;
        },
        /**
         * 初始化文档高度
         */
        ...
        */
        ...
        scrollTo: function(positionVal) {
            ...
            //如果有success就返回执行过程触发
            self.options.hasOwnProperty('success') && self.options.success(positionVal);
        }
    }
    e(i,j);
});