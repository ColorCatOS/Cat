...
;Cat.define("Jquery", function (t) {
    "use strict";
    var e = Cat.$, i = {
        fixbar: function (t) {
            var i, a, n = "Cat-fixbar", r = "Cat-fixbar-top", o = e(document), l = e("body");
            t = e.extend({showHeight: 200}, t), t.bar1 = t.bar1 === !0 ? "&#xe606;" : t.bar1, t.bar2 = t.bar2 === !0 ? "&#xe607;" : t.bar2, t.bgcolor = t.bgcolor ? "background-color:" + t.bgcolor : "";
            var c = [t.bar1, t.bar2, "&#xe604;"],
                g = e(['<ul class="' + n + '">', t.bar1 ? '<li class="Cat-icon" Cat-type="bar1" style="' + t.bgcolor + '">' + c[0] + "</li>" : "", t.bar2 ? '<li class="Cat-icon" Cat-type="bar2" style="' + t.bgcolor + '">' + c[1] + "</li>" : "", '<li class="Cat-icon ' + r + '" Cat-type="top" style="' + t.bgcolor + '">' + c[2] + "</li>", "</ul>"].join("")),
            ...
            e("." + n)[0] || ("object" == typeof t.css && g.css(t.css), l.append(g), u(), g.find("li").on("click", function () {
                var i = e(this), a = i.attr("Cat-type");
